...
public class RequestFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container, Bundle savedInstanceState) {
        ...
        RequestTitleText = (TextView) view.findViewById(R.id.RequestTitleText);

        RequestUs = (EditText) view.findViewById(R.id.Request);
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String RequestUsInput = RequestUs.getText().toString();

                // Check for empty data in the form
                if (RequestUsInput.trim().length() > 0) {

                    if (isNetworkAvaliable(getActivity())) {
                        contactUs("Request", email, USERID, RequestUsInput);}
                    else {
                    ...
                    Toast.makeText(getActivity(),
                            "Please complete the Request field!", Toast.LENGTH_SHORT)
                            .show();
                }
            }
    ...
    public void printData()  {
        ...
        RequestTitleText.setText("If you cannot find a Calender, Category or Reminder you require under the Download tab."
                + "\n" + "\n" +"Please complete the Request field below and we will try to add the requested Calender, Category or Reminder to Task iQ."
     ...
     * */
    private void contactUs(final String tag, final String email, final String userID,  final String RequestUs) {
        ...
        StringRequest strReq = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                Log.d(TAG, "Request Us Response: " + response.toString());
                ...
                try {
                    ...
                    if (!error){
                        ...
                        Toast.makeText(getActivity(), "Request has been received and we will respond via email.", Toast.LENGTH_SHORT).show();
