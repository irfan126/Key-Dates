...
public class CreateRemNoFragment extends Fragment {
    ...
    public void saveProduct(){
        ...
        Log.d(TAG, "Create Category TAG: " + reminderExpiryString + " " + email + " " + catTitle + " " + actDate + " " + actDateTitle + " " + remTitle + " " + remNotes + " " + reminderDateString);
     ...
     if (newCat.equals("Yes")) {
         ...
         int rem_ID = BiggestRemID + 1;
            ...
            dbHandler.addReminders(rem_ID, cat_ID, catTitle, "0", "0", "0", "0", "0", "0", remTitle, "0", imageA, imageB, reminderDateLong1, reminderExpiryLong1, remNotes, "0", userID,  catUploadIDInt,0, "No Summary");
         ...
         int BiggestRemID = dbHandler.NewRemID();
         int rem_ID = BiggestRemID + 1;
         dbHandler.addReminders(rem_ID, catIDIntereger, catTitle, "0", "0", "0","0","0", "0",remTitle, "0",imageA,imageB, reminderDateLong1, reminderExpiryLong1 , remNotes,Upload, userID, catUploadIDInt, 0,uploadSum);
