...
public class ContactUsLoginActivity extends AppCompatActivity {
    ...
    // Log tag
    private static final String TAG = ContactUsLoginActivity.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {

        super.onCreate(savedInstanceState);
        setContentView(R.layout.contactuslogin_activity);
...
// Create a new Fragment to be placed in the activity layout
            ContactUsLoginFragament firstFragment = new ContactUsLoginFragament();
