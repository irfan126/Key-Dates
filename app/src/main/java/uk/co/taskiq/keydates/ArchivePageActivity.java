...
public class ArchivePageActivity extends AppCompatActivity {
    ...
    // Log tag
    private static final String TAG = ArchivePageActivity.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {

        super.onCreate(savedInstanceState);
        setContentView(R.layout.arcpage_activity);
        ...
        if (findViewById(R.id.arcpage_fragment) != null) {
...
// Create a new Fragment to be placed in the activity layout
            ArchivePageFragment firstFragment = new ArchivePageFragment();
            ...
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.arcpage_fragment, firstFragment).commit();
        }
